...
const faqs = [
  {
    question: "What is PictoCopy?",
    answer:
      "PictoCopy is an intelligent photo management application that uses advanced AI to automatically tag and organize your photos based on detected objects, faces, and scenes. It's designed to make your photo collection searchable and easily accessible while maintaining your privacy.",
  ...
  {
    question: "Is my privacy protected when using PictoCopy?",
    answer:
      "Absolutely. PictoCopy is built with a privacy-first approach. All image analysis and processing is performed locally on your device, and your photos never leave your control unless you explicitly choose to share them. We don't store or access your photos on our servers.",
    icon: <Lock className="w-5 h-5" />
  },
  {
    question: "What platforms does PictoCopy support?",
    answer:
      "PictoCopy is designed for cross-platform compatibility. It's available on iOS, Android, macOS, and Windows, allowing you to manage your photo collection seamlessly across all your devices with synchronization options that respect your privacy preferences.",
